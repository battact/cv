      ...
      <div className="container">
        ...
        <div className={`mobile-nav ${isMobileMenuOpen ? 'open' : ''}`}>
          <div className="mobile-nav-links">
            ...
            <a href="#experience" className="nav-link" aria-label="Go to Experience section" onClick={closeMobileMenu}>
              Experience
            </a>
          ...
          <div className="mobile-nav-actions">
            ...
            <a href="/tamas_bartos_cv.pdf" className="btn btn-secondary" target="_blank" rel="noopener noreferrer" aria-label="Download CV (opens in new tab)" onClick={closeMobileMenu}>
              Download CV
            </a>
          </div>
        </div>
